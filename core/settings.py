...
# Default de Django es 2.5MB — insuficiente para fotos de celular (subir_imagen
# de productos, logo, QR, etc). Nginx tiene su propio límite (ver nginx.conf,
# client_max_body_size) que hay que subir en conjunto con este.
